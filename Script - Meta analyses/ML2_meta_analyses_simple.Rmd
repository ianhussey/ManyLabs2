---
title: "ManyLabs 2 meta analysis"
...
outlist1 <- read_csv("../OSFdata/!!RawData/Data_Figure_NOweird.csv")
...
write_rds(outMeta_uni, "outMeta_uni.rds")

# pdf(file.path(dir.out,"FunnelPerAnalysis.pdf"), paper="a4r")    TODO ????
